...
apt-get install -y php8.0-curl php8.0-cli php8.0-intl php8.0-mysqlnd php8.0-gd php8.0-fpm php8.0-mbstring php8.0-xml unzip nginx mysql-server-8.0 php8.0-xdebug
...
sed -i 's/owner = www-data/owner = vagrant/g' /etc/php/8.0/fpm/pool.d/www.conf
...
mysql -uroot <<< "CREATE DATABASE vps"
mysql -uroot <<< "CREATE DATABASE vps_test"
echo "Done!"
